...
from blog.views import KategoriListView, yazilarim, anasayfa, iletisim, DetayView, yorum_sil, YaziSilDeleteView, yazi_guncelle, YaziEkleCreateView, onemli_siteler
